This project focuses on visualizing synaptic connections between neurons, with a particular focus on the Presynapse (axon side) and Postsynapse (dendritic side).
